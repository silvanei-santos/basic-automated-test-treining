...
class MultiplesOf3Or5Test extends TestCase
{
    public function testShouldReturnMultipleOf3Or5(): void
    {
        ...
        $resultFor3 = $multiplesOf3Or5->isMultiple(new NaturalNumber(3));
        $resultFor5 = $multiplesOf3Or5->isMultiple(new NaturalNumber(5));
    ...
    public function testShouldReturnZeroForNotMultipleOf3Or5(): void
    {
        ...
        $resultFor2 = $multiplesOf3Or5->isMultiple(new NaturalNumber(2));
        $resultFor4 = $multiplesOf3Or5->isMultiple(new NaturalNumber(4));
        $resultFor6 = $multiplesOf3Or5->isMultiple(new NaturalNumber(7));
